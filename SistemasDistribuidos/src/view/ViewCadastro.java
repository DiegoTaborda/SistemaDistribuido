...
public class ViewCadastro extends JFrame {
	...
	public ViewCadastro(Socket eSocket) {
		System.out.println("View Cadastro Conectado");
		...
		btnCadastrar.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        String menString = usuario.cadastrar(getTextNome(), getTextEmail(), getTextSenha());
		        ...
		        try {
		            ...
		            if (codigoServidor == 200) {
		                JOptionPane.showMessageDialog(null, "Cadastro realizado com Sucesso", "Cadastro Cliente",
		                ...
		                JOptionPane.showMessageDialog(null, "Cadastro Inválido", "Erro Cadastro Cliente",
		...
		JLabel lblNewLabel_3 = new JLabel("SIISCCM");
		lblNewLabel_3.setBounds(297, 27, 45, 13);
