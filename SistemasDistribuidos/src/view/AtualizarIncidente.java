...
public class AtualizarIncidente extends JFrame {
	...
	public AtualizarIncidente(Socket eSocket, JsonObject aleluia,int id_incidente) {
		...
		JLabel lblReporteIncidente = new JLabel("Atualizar Incidente");
		...
		btnReportar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String mensagemReportarIncidente = incidente.editarIncidente(aleluia.get("token").getAsString(), id_incidente, textData.getText(), textRodovia.getText(), 
						Integer.parseInt(textKm.getText()), comboBoxTipoIncidente.getSelectedIndex() + 1,aleluia.get("id_usuario").getAsInt());
		        ...
		        try {
		            ...
		            if (codigoServidor == 200) {
		                JOptionPane.showMessageDialog(null, "Incidente Atualizado com Sucesso", "Editar Incidente",
		                ...
		                JOptionPane.showMessageDialog(null, "Atualizacao Inválida", "Erro ao Editar Incidente",
